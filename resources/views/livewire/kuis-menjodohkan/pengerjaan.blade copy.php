<div class="bg-gray-100 min-h-screen p-4 md:p-8 font-sans">
    ...
    <div x-data="{
        ...
        gambarGaris(); 
        $watch('pasangan', () => gambarGaris());
    "
        @@resize.window.debounce.150ms="gambarGaris()" class="relative max-w-6xl mx-auto" x-ref="container">
        ...
        <div class="grid grid-cols-2 gap-12 md:gap-48 relative z-10">
            ...
            <div class="space-y-6">
                ...
                <div x-ref="pertanyaan-{{ $item->id }}" wire:click="pilihPertanyaan('{{ $item->id }}')"
                    ...
                    @else
                    <img src="..." class="max-w-[150px] md:max-w-[200px] rounded-lg mx-auto">
                    @endif
                </div>
                @endforeach
            </div>
